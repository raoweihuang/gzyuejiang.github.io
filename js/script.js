...
const forkliftData = [
    ...
    { brand: "明宇重工", type: "燃油叉车", model: "C35", price: 47000, remark: "标配" },
    { brand: "明宇重工", type: "燃油叉车", model: "C38", price: 49500, remark: "标配" },
            ...
            const attachmentConfig = `
                <div class="config-group">
                    ...
                    <select id="attachment-${index}" onchange="togglePipeValve(${index})">
                        ...
                        <option value="4000">倾翻装置（+4000元）</option>
                    </select>
                </div>

                <!-- 管阀：1路400，2路800，3路1200，4路1600 -->
                <div class="config-group pipe-valve-group" id="pipeValveGroup-${index}">
                    <label>管阀选择</label>
            ...
            resultHtml += `
                <div class="price-card" id="forklift-${index}">
                    ...
                    <div class="config-options">
                        ...
                        <div class="config-group">
                            <label>货叉总长度（mm，基准1220mm，150mm递增）</label>
...
function togglePipeValve(index) {
    const attach = document.getElementById(`attachment-${index}`);
    const pipeGroup = document.getElementById(`pipeValveGroup-${index}`);
    if (attach.value == 0) {
        pipeGroup.classList.remove("pipe-valve-show");
    } else {
        pipeGroup.classList.add("pipe-valve-show");
    }
}
